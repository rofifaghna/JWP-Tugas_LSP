...
!(function (t, e) {
  ...
  class X extends j {
    ...
    show() {
      ...
      let t, e;
      this._parent &&
        ((t = H.find(".show, .collapsing", this._parent).filter((t) => ("string" == typeof this._config.parent ? t.getAttribute("data-bs-parent") === this._config.parent : t.classList.contains("collapse")))), 0 === t.length && (t = null));
  ...
  var Ct = {
      ...
      fn: function (t) {
        ...
        null != e.modifiersData.popperOffsets && (e.styles.popper = Object.assign({}, e.styles.popper, xt(Object.assign({}, c, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: r, roundOffsets: l })))),
